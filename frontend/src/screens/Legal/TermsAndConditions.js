...
const TermsAndConditions = () => {
  return (
    <main
      style={{ alignItems: "baseline", margin: "2vh 5vw" }}
    ...
    >
      ...
      <nav>
        ...
        <ul>
          ...
          <li>
            <a href="#4">4. PRODUCTS</a>
          </li>
          <li>
            <a href="#5">5. PURCHASES AND PAYMENT</a>
          </li>
          <li>
            <a href="#6">6. PROHIBITED ACTIVITIES</a>
          </li>
          <li>
            <a href="#7">7. USER GENERATED CONTRIBUTIONS</a>
          </li>
          <li>
            <a href="#8">8. DOW WE COLLECT INFORMATION FROM MINORS?</a>
          </li>
          <li>
            <a href="#9">9. SUBMISSIONS</a>
          </li>
          <li>
            <a href="#10">10. SITE MANAGEMENT</a>
          </li>
          <li>
            <a href="#11">11. TERM AND TERMINATION</a>
          </li>
          <li>
            <a href="#12">12. MODIFICATIONS AND INTERRUPTIONS</a>
          </li>
          <li>
          ...
          <li>
            <a href="#20">20. MISCELLANEOUS</a>
          </li>
          <li>
            <a href="#21">21. CONTACT US</a>
          </li>
        </ul>
      </nav>
      <article>
        <section>
          <h2 id="1">AGREEMENT TO TERMS</h2>
          <p>
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and CARMINE SEMBRA BROOKLYN ("Company", “we”, “us”, or “our”),
        ...
        <section>
          ...
          <p>
            ...
            or licensed to us, and are protected by copyright and Custom
            Branding Hide “Powered by Te Customize Policy Theme Select "Create
            New Theme" ADD TO WEBSITE Sharp (Default) APPLY THEME To create a c
            upgrade. Pro $15/month. trademark laws and various other
        ...
        <section>
          <h2 id="5">5. PURCHASES AND PAYMENT</h2>
          <p>
        ...
        <section>
          <h2 id="6">6. PROHIBITED ACTIVITIES</h2>
          <p>
        ...
        <section>
          <h2 id="7">7. USER GENERATED CONTRIBUTIONS</h2>
          <p>
        ...
        <section>
          <h2 id="8">8. CONTRIBUTION LICENSE</h2>
          <p>
        ...
        <section>
          <h2 id="10">10. SITE MANAGEMENT</h2>
          <p>
        ...
        <section>
          <h2 id="11">11. TERM AND TERMINATION</h2>
          <p>
        ...
        <section>
          <h2 id="12">12. MODIFICATIONS AND INTERRUPTIONS</h2>
          <p>
        ...
        <section>
          ...
          <h4>Informal Negotioations</h4>
          <p>
            o expedite resolution and control the cost of any dispute,
            ...
            those Disputes expressly provided below) informally for at least 14
          ...
          <p>
            ...
            shall be Brescia. The language of the proceedings shall be italian.
            The governing law of the contract shall be substantive law of Italy.
          </p>
          <h4>Restrictions</h4>
          <p>
        ...
        <section>
          ...
          <p>
            <a href="mailto:carminesembrabrooklyn@gmail.com">
              carminesembrabrooklyn@gmail.com
            </a>{" "}
          </p>
          <p>or by post to:</p>
          <p>
